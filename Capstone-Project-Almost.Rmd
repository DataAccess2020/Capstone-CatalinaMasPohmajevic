...
subtitle: "Data Access Course | Data Analytics for Complex Organizations, Università degli Studi di Milano"
...
#Organize and tidy up the datasets
...
#Getting insights from my datasets
...
It's important to mention that these areas represent urban focuses within the city of Buenos Aires constituting central areas where companies, offices, stores and state buildings are located. Therefore, for the scope of this project and giving the aspects analyzed previously, we can just say that these areas are where the vast majority of the crimes are committed, but we can not assert reasons why this happen nor if these are the unsafest zones. It could be that the majority of the crimes are reported here because the majority of the people move towards these urban areas, or that given the fact there are more people in these areas' public spaces - streets, squares, public means of transportations and stations - there is also a tendency to commit crimes here.
As per continuing the research and development of the project it would be valuable to download the dataset of Crimes reported in 2020 once available. In the context of COVID-19 and considering 2020 to be a very particular moment in history, I would be curious to detect variations respecting the quantity of the crimes committed as well as the geographical distribution of these. As a first hypothesis towards proposing the ongoing development of this study, I would say crimes may have decreased during the 2019 and that areas might have changed as a result of people staying at home and not transitting commercial areas.

Word Count excluding code chunks and inline code:
```{r}
wordcountaddin::word_count("Capstone-Project-Almost.Rmd")
```
